            ...
            <div className="flex flex-row justify-center p-5 gap-5 flex-wrap">
                ...
                <div className="bg-stone-950 p-4 rounded-2xl border border-gray-400 w-sm hover:border-red-800 hover:scale-103 transition delay-50 duration-500 ease-in-out flex flex-col justify-between">
                    <div className="relative">
                        <img src="spotify-preview.png" alt="spotify-preview" className="rounded-2xl w-full h-72  object-cover" />
                ...
                <div className="bg-stone-950 p-4 rounded-2xl border border-gray-400 w-sm hover:border-red-800 hover:scale-103 transition delay-50 duration-500 ease-in-out flex flex-col justify-between">
                    <div className="relative">
                        <img src="netflix-preview.png" alt="netflix-preview" className="rounded-2xl w-full h-72  object-cover" />
                        <div className="absolute right-8 top-6 bg-cyan-700 px-2 rounded-2xl">Front End</div>
                    </div>
                ...
                <div className="bg-stone-950 p-4 rounded-2xl border border-gray-400 w-sm hover:border-red-800 hover:scale-103 transition delay-50 duration-500 ease-in-out flex flex-col justify-between">
                    <div className="relative">
                        <img src="weather-preview.png" alt="weather-preview" className="rounded-2xl w-full h-72 object-cover" />
                        <div className="absolute right-8 top-6 bg-cyan-700 px-2 rounded-2xl">Front End</div>
                    </div>
                ...
                <div className="bg-stone-950 p-4 rounded-2xl border border-gray-400 w-sm hover:border-red-800 hover:scale-103 transition delay-50 duration-500 ease-in-out flex flex-col justify-between">
                    <div className="relative">
                        <img src="music-preview.png" alt="music-preview" className="rounded-2xl w-full h-72  object-cover" />
                        <div className="absolute right-8 top-6 bg-cyan-700 px-2 rounded-2xl">Front End</div>
                    </div>
                ...
                <div className="bg-stone-950 p-4 rounded-2xl border border-gray-400 w-sm hover:border-red-800 hover:scale-103 transition delay-50 duration-500 ease-in-out flex flex-col justify-between">
                    <div className="relative">
                        <img src="camping-preview.png" alt="camping-preview" className="rounded-2xl w-full h-72  object-cover" />
