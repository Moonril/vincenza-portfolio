    ...
    return (
        <section className="text-white p-5">
            ...
            <div className="flex flex-row justify-center p-5 gap-5 flex-wrap">
                {/* cards */}
                {/* Spotify vanilla */}
                <div className="bg-stone-950 p-3 rounded-2xl border border-gray-400 w-sm hover:border-red-800 hover:scale-103 transition delay-50 duration-500 ease-in-out">
                    <div className="relative">
                        <img src="spotify-preview.png" alt="spotify-preview" className="rounded-2xl w-full h-72  object-cover border border-slate-700" />
                ...
                <div className="bg-linear-to-r from-slate-950 to-slate-800 p-3 rounded-2xl border border-gray-400 w-sm hover:border-purple-600 hover:scale-103 transition delay-50 duration-500 ease-in-out">
                    <div className="relative">
                        <img src="netflix-preview.png" alt="spotify-preview" className="rounded-2xl w-full h-72  object-cover" />
                        <div className="absolute right-8 top-6 bg-cyan-700 px-2 rounded-2xl">Front End</div>
                    </div>
                ...
                <div className="bg-linear-to-r from-slate-950 to-slate-800 p-3 rounded-2xl border border-gray-400 w-sm hover:border-purple-600 hover:scale-103 transition delay-50 duration-500 ease-in-out">
                    <div className="relative">
                        <img src="weather-preview.png" alt="spotify-preview" className="rounded-2xl w-full h-72 object-cover" />
                        <div className="absolute right-8 top-6 bg-cyan-700 px-2 rounded-2xl">Front End</div>
                    </div>
                ...
                <div className="bg-linear-to-r from-slate-950 to-slate-800 p-3 rounded-2xl border border-gray-400 w-sm hover:border-purple-600 hover:scale-103 transition delay-50 duration-500 ease-in-out">
                    <div className="relative">
                        <img src="music-preview.png" alt="spotify-preview" className="rounded-2xl w-full h-72  object-cover" />
                        <div className="absolute right-8 top-6 bg-cyan-700 px-2 rounded-2xl">Front End</div>
                    </div>
                ...
                <div className="bg-linear-to-r from-slate-950 to-slate-800 p-3 rounded-2xl border border-gray-400 w-sm hover:border-purple-600 hover:scale-103 transition delay-50 duration-500 ease-in-out">
                    <div className="relative">
                        <img src="camping-preview.png" alt="spotify-preview" className="rounded-2xl w-full h-72  object-cover" />
